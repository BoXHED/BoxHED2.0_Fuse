...
def log_artifact(
    ...
    # wandb.login(key=os.getenv('WANDB_KEY'), relogin=True) # aa_ron_su
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--project-name", dest="project_name", help="project name for wandb"
    )
    parser.add_argument(
        "--artifact-name", dest="artifact_name", help="artifact name for wandb"
    )
