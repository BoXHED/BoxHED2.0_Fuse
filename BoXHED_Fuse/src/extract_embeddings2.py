...
if __name__ == "__main__":
    ...
    train_target_path = f'{os.getenv("BHF_ROOT")}/JSS_SUBMISSION/data/targets/till_end_mimic_iv_extra_features_train_NOTE_TARGET_2_{args.note_type[:3]}_all.csv'
    test_target_path = f'{os.getenv("BHF_ROOT")}/JSS_SUBMISSION/data/targets/till_end_mimic_iv_extra_features_test_NOTE_TARGET_2_{args.note_type[:3]}_all.csv'
    train_NOTE_path = f'{os.getenv("BHF_ROOT")}/JSS_SUBMISSION/data/till_end_mimic_iv_extra_features_train_NOTE_{args.note_type[:3]}_all.csv'
    test_NOTE_path = f'{os.getenv("BHF_ROOT")}/JSS_SUBMISSION/data/till_end_mimic_iv_extra_features_test_NOTE_{args.note_type[:3]}_all.csv'
